	...
	return (
		...
		<div class="mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-5 py-16 md:px-10 md:py-20">
			<div>
				...
				<h2>2. License</h2>
				<p>Unless otherwise stated, Textract.tools and/or its licensors own the intellectual property rights for all material on this website. All intellectual property rights are reserved.</p>
				<h2>3. User Responsibilities</h2>
				<p>Users are responsible for ensuring that any use of Textract.tools complies with the laws and regulations of their jurisdiction.</p>
			</div>
		</div>
		</section>
	);
